...
import { updatePengeluaran } from "@/lib/actions/pengeluaran-actions";
...
export function EditButton({
  ...
  async function onSubmit(data: FormData) {
    const res = await updatePengeluaran(id, data);
    if (res.error) {
      return toast({
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Silahkan isi form berikut untuk mengubah pengeluaran
          </DialogDescription>
        </DialogHeader>
