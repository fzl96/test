...
type InputProps = {
  ...
  onFileAdded?: (file: File) => void | Promise<void>;
...
const ERROR_MESSAGES = {
  fileTooLarge(maxSize: number) {
    return `File terlalu besar. Ukuran Max ${formatFileSize(maxSize)}.`;
  },
  fileInvalidType() {
    return "Tipe file tidak valid.";
  },
  tooManyFiles(maxFiles: number) {
    return `Hanya bisa menambahkan ${maxFiles} file.`;
  },
  fileNotSupported() {
    return "File ini tidak didukung.";
  },
};
